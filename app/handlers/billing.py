...
BILLING_TEXT = (
    "💎 **Подписки**\n\n"
    "**Free** — базовые генерации и тестовый контент\n"
    f"**Pro** ({settings.pro_price_stars} ⭐) — больше фото, рекламные серии, расширенные видео\n"
    f"**Premium** ({settings.premium_price_stars} ⭐) — безлимит, private-модуль и приоритетные тесты\n\n"
    "Основной продукт — AI Content Factory для моделей, товаров, Instagram/Reels и рекламы.\n"
