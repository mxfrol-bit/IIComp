...
WELCOME = (
    ...
    "Контент-завод для виртуальных AI-моделей, товаров, рекламы, Instagram и Reels.\n\n"
    "Быстрый путь:\n"
    "1. 🚀 Быстрый старт\n"
    "2. 🧬 Создать AI-модель с hero face\n"
    "3. 📦 Загрузить товар\n"
    "4. 📢 Сделать рекламный кадр\n"
    "5. 🎥 Собрать Reels / видео\n"
)

HELP = (
    "❓ Помощь\n\n"
    "🚀 Быстрый старт — ведёт по шагам: модель → товар → рекламный кадр.\n"
    "🧬 AI-модель — виртуальный инфлюенсер с hero face и identity pack.\n"
    "📦 Товар — фото/описание бутылки, шоколадки, платья, косметики, гаджета и т.д.\n"
    "📢 Реклама с товаром — product-aware генерация: одежда через try-on, товары через product integration.\n"
    "🎥 Видео / Reels — делается из готового кадра: движение, формат и длина.\n"
    "🧾 Контент-план — идеи постов, Reels, рекламных креативов и hooks.\n\n"
    "Качество: для продающего результата используй чистые фото товара, full-body сценарии для одежды и PHOTO_QUALITY_MODE=pro/max."
)
